...
if not isfolder("Aries hub") then
    makefolder("Aries hub")
end
...
function Library:load_flags()
    if not isfile(`Aries hub/{game.GameId}.lua`) then Library.save_flags() return end

    local flags = readfile(`Aries hub/{game.GameId}.lua`)
